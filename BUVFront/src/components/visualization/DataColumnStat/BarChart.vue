<template>
    <g>
        ...
        <g>
            <rect
                    v-for="(obj, i) in data.list" :key="i"
                    :x="xScale(i)" :y="height - yScale(obj[1])" :width="unitWidth" :height="yScale(obj[1])" fill="steelblue"></rect>
        </g>
    </g>
</template>
...
export default {
    ...
    mounted(){
        ...
        this.xScale.domain([0, this.data.list.length - 1]).range([0, this.width])
